...
<style>
    ...
    .range-fill {
        background: #4ade80; height: 100%; border-radius: 6px; opacity: 0.5;
    }
    .price-pointer {
...
# --- 2. КОНСТАНТЫ (ЧИСТЫЕ СТРОКИ) ---
# Принудительно очищаем URL от возможных скрытых символов
RPC_URL = "https://arb1.arbitrum.io/rpc".strip()
NFT_MANAGER = "0xC36442b4a4522E871399CD717aBDD847Ab11FE88".strip()
FACTORY_ADDR = "0x1F98431c8aD98523631AE4a59f267346ea31F984".strip()

w3 = Web3(Web3.HTTPProvider(RPC_URL))

# Сокращенные ABI для стабильности
ABI_NFT = [
...
# --- 4. ИНТЕРФЕЙС ---
st.title("Architect DeFi Pro 2026")
wallet = st.sidebar.text_input("Кошелек Arbitrum", "0x995907fe97C9CAd3D310c4F384453E8676F4a170")
...
if btn and wallet:
    try:
        ...
        nft_contract = w3.eth.contract(address=w3.to_checksum_address(NFT_MANAGER), abi=ABI_NFT)
        factory = w3.eth.contract(address=w3.to_checksum_address(FACTORY_ADDR), abi=ABI_FACTORY)

        count = nft_contract.functions.balanceOf(target).call()
        st.write(f"Найдено позиций: {count}")
            ...
            <div class="metric-card">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div class="stat-box" style="background: rgba(16, 185, 129, 0.2);">
                        <div style="font-size: 0.8em; opacity: 0.8;">Комиссии</div>
                        <div style="font-size: 1.5em; font-weight: bold;">+ ${fee_usd:,.4f}</div>
                ...
                <div style="display: flex; justify-content: space-between; font-size: 0.9em;">
                    ...
                    <span style="color: #fbbf24;">Цена: <b>{p_now:,.1f}</b></span>
